  ...
  const characters: Character[] = [
    {
      ...
      spells: [],
      inventory: [
        { id: newId(), name: "Longsword", quantity: 1, equipped: true, description: "1d8 slashing (1d10 two-handed)." },
        { id: newId(), name: "Shield", quantity: 1, equipped: true },
        { id: newId(), name: "Chain Mail", quantity: 1, equipped: true },
        { id: newId(), name: "Handaxe", quantity: 2 },
        { id: newId(), name: "Potion of Healing", quantity: 3, description: "Regain 2d4+2 HP." },
      ],
      features: [
    ...
    },
    {
      ...
      inventory: [
        { id: newId(), name: "Mace", quantity: 1, equipped: true },
        { id: newId(), name: "Chain Mail", quantity: 1, equipped: true },
        { id: newId(), name: "Shield (Holy Symbol)", quantity: 1, equipped: true },
        { id: newId(), name: "Healer's Kit", quantity: 1 },
      ],
      features: [
    ...
    },
    {
      ...
      inventory: [
        { id: newId(), name: "Rapier", quantity: 1, equipped: true },
        { id: newId(), name: "Shortbow", quantity: 1, equipped: true },
        { id: newId(), name: "Leather Armor", quantity: 1, equipped: true },
        { id: newId(), name: "Thieves' Tools", quantity: 1 },
        { id: newId(), name: "Smokebombs", quantity: 4 },
      ],
      features: [
